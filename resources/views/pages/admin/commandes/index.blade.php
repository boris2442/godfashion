    ...
    <table class="min-w-full bg-white border border-gray-200">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-4 py-2 border">
                    <a href="{{ route('admin.commandes.edit', $commande->id) }}" class="text-blue-500 hover:underline">Modifier</a>
                    <form action="{{ route('admin.commandes.destroy', $commande->id) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="text-red-500 hover:underline" onclick="return confirm('Voulez-vous vraiment supprimer cette commande ?')">Supprimer</button>
                    </form>
                </td>
            </tr>
            @endforeach
